...
-- Table: role
CREATE TABLE role (id int NOT NULL AUTO_INCREMENT, userID int NOT NULL, roleName varchar(100) NOT NULL DEFAULT 'player', userName varchar(100) NOT NULL , isDeleted bool NOT NULL DEFAULT 0, CONSTRAINT role_pk PRIMARY KEY (id));
-- Table: subCritter
