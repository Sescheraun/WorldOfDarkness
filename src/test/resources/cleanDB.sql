...
-- Table: role
CREATE TABLE role (id int NOT NULL,userID int NOT NULL, roleName varchar(100) NOT NULL DEFAULT 'player', userName varchar(100) NOT NULL, CONSTRAINT role_pk PRIMARY KEY (id));
-- Table: subCritter
